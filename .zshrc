...
export ZSH="/Users/chrishowlett/.oh-my-zsh"
...
alias config='/usr/bin/git --git-dir=/Users/chrishowlett/.cfg/ --work-tree=/Users/chrishowlett'
...
PROMPT='%(?:%{$fg[green]%}➜ :%{$fg[red]%}➜ ) %{$fg[cyan]%}%c%{$reset_color%} $(git_super_status) '
