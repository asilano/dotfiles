...
exports.prependSuggestionComment = exports.mergeSuggestions = exports.AVOID_TOP_LEVEL_RETURN = exports.AVOID_TOP_LEVEL_THIS = exports.SHORTEN_NULL_CHECKS = exports.AVOID_INITCLASS = exports.AVOID_IIFES = exports.FIX_INCLUDES_EVALUATION_ORDER = exports.CLEAN_UP_FOR_OWN_LOOPS = exports.SIMPLIFY_DYNAMIC_RANGE_LOOPS = exports.SIMPLIFY_COMPLEX_ASSIGNMENTS = exports.AVOID_INLINE_ASSIGNMENTS = exports.REMOVE_GUARD = exports.CLEAN_UP_IMPLICIT_RETURNS = exports.REMOVE_ARRAY_FROM = exports.FIX_INVALID_CONSTRUCTOR = void 0;
var tslib_1 = require("tslib");
exports.FIX_INVALID_CONSTRUCTOR = {
...
function prependSuggestionComment(code, suggestions) {
    ...
    var commentLines = tslib_1.__spreadArray(tslib_1.__spreadArray([
        '/*',
        ' * decaffeinate suggestions:'
    ], tslib_1.__read(suggestions.map(function (_a) {
    ...
    if (codeLines[0].startsWith('#!')) {
        return tslib_1.__spreadArray(tslib_1.__spreadArray([codeLines[0]], tslib_1.__read(commentLines)), tslib_1.__read(codeLines.slice(1))).join('\n');
    }
    else {
        return tslib_1.__spreadArray(tslib_1.__spreadArray([], tslib_1.__read(commentLines)), tslib_1.__read(codeLines)).join('\n');
    }
}
