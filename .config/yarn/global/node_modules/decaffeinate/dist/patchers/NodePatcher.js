...
var referencesArguments_1 = tslib_1.__importDefault(require("../utils/referencesArguments"));
...
var NodePatcher = /** @class */ (function () {
    ...
    NodePatcher.prototype.setupLocationInformation = function () {
        ...
        for (;;) {
            ...
            if (!previousSurroundingToken ||
                (previousSurroundingToken.type !== coffee_lex_1.SourceType.LPAREN && previousSurroundingToken.type !== coffee_lex_1.SourceType.CALL_START)) {
                break;
            }
            if (!nextSurroundingToken ||
                (nextSurroundingToken.type !== coffee_lex_1.SourceType.RPAREN && nextSurroundingToken.type !== coffee_lex_1.SourceType.CALL_END)) {
                break;
            }
    ...
    NodePatcher.prototype.isNodeFunctionApplication = function (node) {
        return node instanceof nodes_1.FunctionApplication || node instanceof nodes_1.SoakedFunctionApplication || node instanceof nodes_1.NewOp;
    };
    /**
    ...
    NodePatcher.prototype.indent = function (offset, _a) {
        ...
        var _b = _a === void 0 ? {} : _a, _c = _b.skipFirstLine, skipFirstLine = _c === void 0 ? false : _c;
        if (offset === 0) {
            return;
        }
    ...
    NodePatcher.prototype.patchInIIFE = function (innerPatchFn) {
        ...
        innerPatchFn();
        if (this.containsYield()) {
            if (referencesArguments_1.default(this.node)) {
