...
var AssignOpPatcher = /** @class */ (function (_super) {
    ...
    AssignOpPatcher.prototype.patchAsExpression = function () {
        ...
        if (canPatchAssigneeToJavaScript_1.default(this.assignee.node, this.options)) {
            ...
            assignments.push.apply(assignments, tslib_1.__spreadArray([], tslib_1.__read(this.generateAssignments(this.assignee, expressionCode, true))));
    ...
    AssignOpPatcher.prototype.generateAssignments = function (patcher, ref, refIsRepeatable) {
        ...
        if (patcher instanceof ExpansionPatcher_1.default) {
            ...
            if (!refIsRepeatable) {
                ...
                return tslib_1.__spreadArray([arrReference + " = " + ref], tslib_1.__read(this.generateAssignments(patcher, arrReference, true)));
            }
            ...
            try {
                for (var _c = tslib_1.__values(assignees.entries()), _d = _c.next(); !_d.done; _d = _c.next()) {
                    ...
                    assignments.push.apply(assignments, tslib_1.__spreadArray([], tslib_1.__read(this.generateAssignments(assignee, valueCode, false))));
                }
            }
            ...
            if (!refIsRepeatable) {
                ...
                return tslib_1.__spreadArray([objReference + " = " + ref], tslib_1.__read(this.generateAssignments(patcher, objReference, true)));
            }
            var assignments = [];
            try {
                for (var _f = tslib_1.__values(patcher.members), _g = _f.next(); !_g.done; _g = _f.next()) {
                    ...
                    if (member instanceof ObjectInitialiserMemberPatcher_1.default) {
                        ...
                        assignments.push.apply(assignments, tslib_1.__spreadArray([], tslib_1.__read(this.generateAssignments(member.expression || member.key, valueCode, false))));
                    }
                        ...
                        assignments.push.apply(assignments, tslib_1.__spreadArray([], tslib_1.__read(this.generateAssignments(member, valueCode, false))));
                    }
                        ...
                        var omittedKeysCode = getObjectAssigneeKeys_1.default(patcher)
                            ...
                            .join(', ');
                        assignments.push.apply(assignments, tslib_1.__spreadArray([], tslib_1.__read(this.generateAssignments(member, helper + "(" + ref + ", [" + omittedKeysCode + "])", false))));
                    }
                    else {
            ...
            if (!refIsRepeatable) {
                ...
                return tslib_1.__spreadArray([valReference + " = " + ref], tslib_1.__read(this.generateAssignments(patcher, valReference, true)));
            }
