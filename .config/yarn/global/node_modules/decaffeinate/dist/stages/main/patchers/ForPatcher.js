...
var getAssigneeBindings_1 = tslib_1.__importDefault(require("../../../utils/getAssigneeBindings"));
...
var LoopPatcher_1 = tslib_1.__importDefault(require("./LoopPatcher"));
...
var ForPatcher = /** @class */ (function (_super) {
    ...
    ForPatcher.prototype.getIIFEAssignments = function () {
        if (this.willPatchAsIIFE()) {
            var iifeAssignments = [];
            if (this.keyAssignee) {
                iifeAssignments.push.apply(iifeAssignments, tslib_1.__spreadArray([], tslib_1.__read(getAssigneeBindings_1.default(this.keyAssignee.node))));
            }
            if (this.valAssignee) {
                iifeAssignments.push.apply(iifeAssignments, tslib_1.__spreadArray([], tslib_1.__read(getAssigneeBindings_1.default(this.valAssignee.node))));
            }
    ...
    ForPatcher.prototype.getRelationToken = function () {
        ...
        function (token) { return token.type === coffee_lex_1.SourceType.RELATION || token.type === coffee_lex_1.SourceType.IDENTIFIER; });
        if (!tokenIndex) {
            throw this.error("cannot find relation keyword in 'for' loop");
        }
        return notNull_1.default(this.sourceTokenAtIndex(tokenIndex));
    };
    /**
     * @protected
     */
    ...
    ForPatcher.prototype.computeIndexBinding = function () {
        ...
        if (keyAssignee) {
            if (keyAssignee instanceof MemberAccessOpPatcher_1.default) {
                return "this." + keyAssignee.member.node.data;
            }
            else if (keyAssignee instanceof IdentifierPatcher_1.default) {
    ...
    ForPatcher.prototype.isThisAssignIndexBinding = function () {
        return this.keyAssignee instanceof MemberAccessOpPatcher_1.default;
    };
    /**
     * @protected
     */
    ...
    ForPatcher.prototype.removeThenToken = function () {
        ...
        var index = this.indexOfSourceTokenBetweenSourceIndicesMatching(searchStart, searchEnd, function (token) { return token.type === coffee_lex_1.SourceType.THEN; });
        if (index) {
            var thenToken = notNull_1.default(this.sourceTokenAtIndex(index));
    ...
    ForPatcher.prototype.getTargetCode = function () {
        ...
        return notNull_1.default(this._targetCode);
    };
    ForPatcher.prototype.getTargetReference = function () {
        this.computeTargetCodeIfNecessary();
        return notNull_1.default(this._targetReference);
    };
