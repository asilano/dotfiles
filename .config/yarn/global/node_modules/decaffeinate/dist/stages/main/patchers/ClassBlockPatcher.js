    ...
    ClassBlockPatcher.prototype.patch = function (options) {
        ...
        if (!this.hasConstructor()) {
            ...
            if (boundMethods.length > 0) {
                ...
                var bindingStatements = boundMethods
                    .map(function (method) { return "" + methodBodyIndent_1 + getBindingCodeForMethod_1.default(method) + ";\n"; })
                    .join('');
                if (isSubclass) {
                    var superStatement = methodBodyIndent_1 + "super(...args)\n";
                    if (this.options.useCS2) {
