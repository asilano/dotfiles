...
var countVariableUsages_1 = tslib_1.__importDefault(require("../../../utils/countVariableUsages"));
var notNull_1 = tslib_1.__importDefault(require("../../../utils/notNull"));
var Scope_1 = tslib_1.__importDefault(require("../../../utils/Scope"));
...
var BlockPatcher = /** @class */ (function (_super) {
    ...
    BlockPatcher.prototype.initialize = function () {
        ...
        var _loop_1 = function (iifePatcher) {
            ...
            try {
                for (var _e = (e_2 = void 0, tslib_1.__values(fakeScope.getOwnNames())), _f = _e.next(); !_f.done; _f = _e.next()) {
                    var name = _f.value;
