...
var AssignOpPatcher = /** @class */ (function (_super) {
    ...
    AssignOpPatcher.prototype.patchAsExpression = function () {
        ...
        if (canPatchAssigneeToJavaScript(this.assignee.node, this.options)) {
            ...
            assignments.push.apply(assignments, __spreadArray([], __read(this.generateAssignments(this.assignee, expressionCode, true))));
    ...
    AssignOpPatcher.prototype.generateAssignments = function (patcher, ref, refIsRepeatable) {
        ...
        if (patcher instanceof ExpansionPatcher) {
            ...
            if (!refIsRepeatable) {
                ...
                return __spreadArray([arrReference + " = " + ref], __read(this.generateAssignments(patcher, arrReference, true)));
            }
            ...
            try {
                for (var _c = __values(assignees.entries()), _d = _c.next(); !_d.done; _d = _c.next()) {
                    ...
                    assignments.push.apply(assignments, __spreadArray([], __read(this.generateAssignments(assignee, valueCode, false))));
                }
            }
            ...
            if (!refIsRepeatable) {
                ...
                return __spreadArray([objReference + " = " + ref], __read(this.generateAssignments(patcher, objReference, true)));
            }
            var assignments = [];
            try {
                for (var _f = __values(patcher.members), _g = _f.next(); !_g.done; _g = _f.next()) {
                    ...
                    if (member instanceof ObjectInitialiserMemberPatcher) {
                        ...
                        assignments.push.apply(assignments, __spreadArray([], __read(this.generateAssignments(member.expression || member.key, valueCode, false))));
                    }
                        ...
                        assignments.push.apply(assignments, __spreadArray([], __read(this.generateAssignments(member, valueCode, false))));
                    }
                        ...
                        var omittedKeysCode = getObjectAssigneeKeys(patcher)
                            ...
                            .join(', ');
                        assignments.push.apply(assignments, __spreadArray([], __read(this.generateAssignments(member, helper + "(" + ref + ", [" + omittedKeysCode + "])", false))));
                    }
                    else {
            ...
            if (!refIsRepeatable) {
                ...
                return __spreadArray([valReference + " = " + ref], __read(this.generateAssignments(patcher, valReference, true)));
            }
