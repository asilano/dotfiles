...
var getCompareOperator_1 = tslib_1.__importDefault(require("../../../utils/getCompareOperator"));
var isCompareOpNegationUnsafe_1 = tslib_1.__importDefault(require("../../../utils/isCompareOpNegationUnsafe"));
...
var ChainedComparisonOpPatcher = /** @class */ (function (_super) {
    ...
    ChainedComparisonOpPatcher.prototype.patchAsExpression = function (_a) {
        ...
        var _e = _a === void 0 ? {} : _a, _f = _e.needsParens, needsParens = _f === void 0 ? false : _f;
        ...
        try {
            for (var _g = tslib_1.__values(this.operands.entries()), _h = _g.next(); !_h.done; _h = _g.next()) {
                var _j = tslib_1.__read(_h.value, 2), i = _j[0], operand = _j[1];
                operand.patch();
