...
var FunctionApplicationPatcher = /** @class */ (function (_super) {
    __extends(FunctionApplicationPatcher, _super);
    ...
    FunctionApplicationPatcher.prototype.patchAsExpression = function (_a) {
        var _this = this;
        var _b = _a === void 0 ? {} : _a, _c = _b.fnNeedsParens, fnNeedsParens = _c === void 0 ? false : _c;
        var _d = this, args = _d.args, outerEndTokenIndex = _d.outerEndTokenIndex;
        if (fnNeedsParens) {
