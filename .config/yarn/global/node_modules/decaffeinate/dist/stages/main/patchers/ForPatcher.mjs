...
var ForPatcher = /** @class */ (function (_super) {
    ...
    ForPatcher.prototype.getIIFEAssignments = function () {
        if (this.willPatchAsIIFE()) {
            var iifeAssignments = [];
            if (this.keyAssignee) {
                iifeAssignments.push.apply(iifeAssignments, __spreadArray([], __read(getAssigneeBindings(this.keyAssignee.node))));
            }
            if (this.valAssignee) {
                iifeAssignments.push.apply(iifeAssignments, __spreadArray([], __read(getAssigneeBindings(this.valAssignee.node))));
            }
