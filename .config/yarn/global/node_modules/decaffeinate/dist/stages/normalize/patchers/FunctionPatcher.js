...
var stripSharedIndent_1 = tslib_1.__importDefault(require("../../../utils/stripSharedIndent"));
        ...
        try {
            for (var _c = tslib_1.__values(this.parameters.entries()), _d = _c.next(); !_d.done; _d = _c.next()) {
                ...
                if (firstRestParamIndex === -1 || i < firstRestParamIndex) {
                    ...
                    assignments.push.apply(assignments, tslib_1.__spreadArray([], tslib_1.__read(newAssignments)));
                    neededExplicitBindings.push.apply(neededExplicitBindings, tslib_1.__spreadArray([], tslib_1.__read(newBindings)));
                }
                else {
                    parameter.patch();
                }
        ...
        if (firstRestParamIndex !== -1) {
            if (firstRestParamIndex === this.parameters.length - 1 &&
                ...
                for (var i = firstRestParamIndex; i < this.parameters.length; i++) {
                    neededExplicitBindings.push.apply(neededExplicitBindings, tslib_1.__spreadArray([], tslib_1.__read(getAssigneeBindings_1.default(this.parameters[i].node))));
                }
            }
        }
        var uniqueExplicitBindings = tslib_1.__spreadArray([], tslib_1.__read(new Set(neededExplicitBindings)));
        // To avoid ugly code, limit the explicit `var` to cases where we're
        // actually shadowing an outer variable.
        uniqueExplicitBindings = uniqueExplicitBindings.filter(function (name) { return notNull_1.default(_this.parent).getScope().hasBinding(name); });
    ...
    FunctionPatcher.prototype.patchParameterAndGetAssignments = function (parameter) {
        ...
        this.addDefaultParamAssignmentAtScopeHeader = function (assigneeCode, initCode, assigneeNode) {
            if (assigneeNode.type === 'Identifier' || assigneeNode.type === 'MemberAccessOp') {
                ...
                newBindings.push.apply(newBindings, tslib_1.__spreadArray([], tslib_1.__read(getAssigneeBindings_1.default(assigneeNode))));
                return paramName;
            }
        };
        parameter.patch();
        ...
        return {
            newAssignments: tslib_1.__spreadArray(tslib_1.__spreadArray([], tslib_1.__read(defaultParamAssignments)), tslib_1.__read(thisAssignments)),
