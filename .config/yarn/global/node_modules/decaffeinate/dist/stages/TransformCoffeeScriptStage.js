...
var DecaffeinateContext_1 = tslib_1.__importDefault(require("../utils/DecaffeinateContext"));
...
var TransformCoffeeScriptStage = /** @class */ (function () {
    ...
    TransformCoffeeScriptStage.prototype.patcherForNode = function (node, parent, property) {
        ...
        var patcher = new (constructor.bind.apply(constructor, tslib_1.__spreadArray([void 0, patcherContext], tslib_1.__read(children))))();
