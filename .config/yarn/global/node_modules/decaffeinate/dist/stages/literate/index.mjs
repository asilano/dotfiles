    ...
    for (var i = 0; i < lines.length; i++) {
        ...
        if (commentLines === null) {
            ...
            if (lineIsEmpty(line) || !lineIsIndented(line) || (i > 0 && !lineIsEmpty(lines[i - 1]))) {
                ...
                resultLines.push.apply(resultLines, __spreadArray([], __read(convertCommentLines(commentLines))));
                commentLines = null;
                resultLines.push(removeIndentation(line));
            }
        }
...
function removeIndentation(line) {
    var e_1, _a;
    try {
        for (var VALID_INDENTATIONS_1 = __values(VALID_INDENTATIONS), VALID_INDENTATIONS_1_1 = VALID_INDENTATIONS_1.next(); !VALID_INDENTATIONS_1_1.done; VALID_INDENTATIONS_1_1 = VALID_INDENTATIONS_1.next()) {
