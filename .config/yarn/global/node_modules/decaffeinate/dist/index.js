...
exports.modernizeJS = exports.convert = exports.PatchError = exports.run = void 0;
...
Object.defineProperty(exports, "run", { enumerable: true, get: function () { return tslib_1.__importDefault(cli_1).default; } });
...
function convert(source, options) {
    ...
    var stages = tslib_1.__spreadArray(tslib_1.__spreadArray([], tslib_1.__read((literate ? [index_3.default] : []))), [
        index_5.default,
        index_4.default,
        index_1.default,
        index_6.default,
...
function runStages(initialContent, options, stages) {
    ...
    stages.forEach(function (stage) {
        ...
        content = code;
        suggestions.push.apply(suggestions, tslib_1.__spreadArray([], tslib_1.__read(stageSuggestions)));
    });
