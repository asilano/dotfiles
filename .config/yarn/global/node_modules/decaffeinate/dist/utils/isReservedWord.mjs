...
var JS_FORBIDDEN = new Set(__spreadArray(__spreadArray(__spreadArray([], __read(JS_KEYWORDS)), __read(RESERVED)), __read(STRICT_PROSCRIBED)));
var RESERVED_WORDS = new Set(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray([], __read(JS_KEYWORDS)), __read(COFFEE_KEYWORDS)), __read(COFFEE_ALIASES)), __read(RESERVED)), __read(STRICT_PROSCRIBED)), [
