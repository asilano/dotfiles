...
function formatAstNodeLines(node, context) {
    ...
    try {
        ...
        for (var _g = tslib_1.__values(Object.keys(node)), _h = _g.next(); !_h.done; _h = _g.next()) {
            ...
            if (Array.isArray(value) && value.length === 0) {
                        ...
                        if (Array.isArray(child)) {
                            ...
                            try {
                                for (var child_1 = (e_4 = void 0, tslib_1.__values(child)), child_1_1 = child_1.next(); !child_1_1.done; child_1_1 = child_1.next()) {
                                    ...
                                    propLines.push.apply(propLines, tslib_1.__spreadArray([], tslib_1.__read(formatAstNodeLines(grandchild, context).map(function (s) { return '    ' + s; }))));
                                }
                            }
                            ...
                            propLines.push.apply(propLines, tslib_1.__spreadArray([], tslib_1.__read(formatAstNodeLines(child, context).map(function (s) { return '  ' + s; }))));
                        }
                    }
                }
                ...
                propLines.push.apply(propLines, tslib_1.__spreadArray([], tslib_1.__read(childLines)));
            }
        }
    }
    ...
    ], tslib_1.__read(propLines.map(function (s) { return '  ' + s; }))), [
        '}',
    ]);
}
