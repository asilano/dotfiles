...
export default function formatDecaffeinateParserAst(program, context) {
...
function formatAstNodeLines(node, context) {
    ...
    try {
        for (var _d = __values(Object.keys(node)), _e = _d.next(); !_e.done; _e = _d.next()) {
            var key = _e.value;
    ...
    try {
        for (var childPropNames_1 = __values(childPropNames), childPropNames_1_1 = childPropNames_1.next(); !childPropNames_1_1.done; childPropNames_1_1 = childPropNames_1.next()) {
            ...
            if (value === null) {
                ...
                try {
                    for (var value_1 = (e_3 = void 0, __values(value)), value_1_1 = value_1.next(); !value_1_1.done; value_1_1 = value_1.next()) {
                        ...
                        propLines.push.apply(propLines, __spreadArray([], __read(formatAstNodeLines(child, context).map(function (s) { return '  ' + s; }))));
                    }
                }
                ...
                propLines.push.apply(propLines, __spreadArray([], __read(childLines)));
            }
        }
    }
    ...
    return __spreadArray(__spreadArray([node.type + " " + rangeStr + " {"], __read(propLines.map(function (s) { return '  ' + s; }))), ['}']);
}
