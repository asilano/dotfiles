...
function formatAstNodeLines(node, context) {
                        ...
                        if (Array.isArray(child)) {
                            ...
                            try {
                                for (var child_1 = (e_4 = void 0, __values(child)), child_1_1 = child_1.next(); !child_1_1.done; child_1_1 = child_1.next()) {
                                    ...
                                    propLines.push.apply(propLines, __spreadArray([], __read(formatAstNodeLines(grandchild, context).map(function (s) { return '    ' + s; }))));
                                }
                            }
    ...
    ], __read(propLines.map(function (s) { return '  ' + s; }))), [
        '}',
    ]);
}
