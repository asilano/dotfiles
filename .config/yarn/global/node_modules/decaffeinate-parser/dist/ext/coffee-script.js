...
exports.patchCoffeeScript = void 0;
...
function patchCoffeeScript() {
    nodes_1.Op.prototype.invert = invert;
    nodes_1.Base.prototype.invert = invert;
    nodes_2.Op.prototype.invert = invert;
    nodes_2.Base.prototype.invert = invert;
}
