 ...
 */
export default function parseCS1AsCS2(source) {
    var cs1AST = nodes(source);
...
function makeCS2Comment(comment) {
    var valueNode = Object.create(Value.prototype);
    var passthroughNode = Object.create(PassthroughLiteral.prototype);
